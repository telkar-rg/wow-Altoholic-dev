...
L["Adolescent Whelp"] = "작은 새끼용" 	-- Tiny Emerald Whelpling
...
L["Apothecary Trio"] = "약종상 트리오" 	-- Love is in the air
L["Apprentice"] = "수습"
L["Arcanoweave Vestments"] = true
L["Argent Tournament"] = "은빛십자군 마상시합" 	-- Argent Tournament
...
L["Blue Scalebane"] = "푸른용혈족 맹독전사" 	-- Azure Whelpling
L["Books"] = "책"
L["Booty Run"] = true
L["Both factions"] = "양쪽 평판"
L["Both parties must enable account sharing\nbefore using this feature (see options)"] = true
L["Box of Chocolates"] = "초콜릿 상자" 	-- Love is in the Air
L["Brewfest"] = true
L["Brewfest Prize Token"] = "가을 축제 상품 교환 동전" 	-- Brewfest
L["Briarthorn"] = "찔레가시"
L["Brightly Colored Egg"] = true
L["Bruiseweed"] = "생채기풀"
L["Burning Blossom"] = "불타는 꽃" 	-- Event: Midsummer Fire Festival
L["Burning Rage"] = true
L["Cache of the Legion"] = true
L["Calendar"] = "달력"
L["Candy Bucket"] = "사탕 바구니" 	-- Hallow's End
...
L["Champion's Seal"] = "용사의 인장" 	-- Argent Tournament
L["Character"] = "캐릭터"
L["Characters"] = "캐릭터"
...
L["Crimson Whelp"] = "심홍색 새끼용" 	-- Tiny Crimson Whelpling
...
L["Dinner Suit Box"] = "정찬복 상자" 	-- Love is in the air
...
L["DPS"] = "초 당 데미지(DPS)"
L["Draconic Magelord"] = "용혈족 마술군주" 	-- Azure Whelpling
L["Draconic Mageweaver"] = "용혈족 마술사" 	-- Azure Whelpling
L["Dragonscale"] = "용비늘"
L["Dreamfoil"] = "꿈풀"
L["Dreaming Glory"] = "꿈초롱이"
L["Dreaming Whelp"] = "꿈의 새끼용" 	-- Tiny Emerald Whelpling
...
L["Flame Cap"] = true
L["Flame Guard"] = true
L["Flamesnorting Whelp"] = "불뿜는 새끼용" 	-- Tiny Crimson Whelpling
L["Food"] = "음식"
L["Forgosh"] = true
L["free"] = "여유"
...
L["Gift of Adoration"] = true 	-- Love is in the Air
L["Glowcap"] = true
L["Gnomish"] = "노움"
L["Goblin"] = "고블린"
L["Goblin AH"] = "고블린 경매장"
...
L["Looking For Multitudes"] = "몸만 오세요" 	-- Dungeon & Raid achievements
...
L["Love is in the air"] = "온누리에 사랑을" 	-- Love is in the air
L["Love Token"] = "사랑의 징표" 	-- Love is in the air
L["Lovely Dress Box"] = "아름다운 드레스 상자" 	-- Love is in the air
...
L["Noblegarden"] = "귀족의 정원" 	-- Noblegarden
L["Noblegarden Chocolate"] = "귀족의 정원 초콜릿" 	-- Noblegarden
...
L["Obtain %d companion pets"] = "애완동물 %d마리 모으기" 	-- General achievements
...
L["Prince Tenris Mirkblood"] = "공작 텐리스 머크블러드" 	-- Scourge Invasion
...
L["Ravasaur Matriarch's Nest"] = "우두머리 라바사우루스의 둥지"
L["Razormaw Matriach's Nest"] = "무쇠턱 우두머리랩터의 둥지"
L["Razzashi Raptor"] = "래즈자쉬 랩터"
L["Realm"] = "서버"
L["Realm %s successfully deleted"] = "%s 서버가 성공적으로 삭제됨"
L["Red Whelp"] = "새끼 붉은용" 	-- Tiny Crimson Whelpling
...
L["Scalding Whelp"] = "끓어오르는 새끼비룡" 	-- Dark Whelpling
...
L["Searing Whelp"] = "화염 새끼용" 	-- Dark Whelpling
...
L["Timed Chest"] = true
L["Time-Lost Scroll"] = "잃어버린 시간의 두루마리" 	-- Terrokar Quest Item
L["Tin Vein"] = "주석 광맥"
L["toggle"] = "토글"
...
L["Transparency"] = "투명도"
L["Trash Mobs"] = true
L["Treat Bag"] = "선물 가방" 	-- Hallow's End
L["Tribal"] = "전통"
L["Tribute Run"] = true
L["Trinkets"] = "장신구"
...
L["Dalaran Jewelcrafter's Token"] = "달라란 보석세공사의 징표"
...
L["'Heroes of Azeroth'"] 	= "'아제로스의 영웅들'" 	-- 25078
L["'Through the Dark Portal'"] 	= "'어둠의 문을 지나서'" 	-- 25080
L["'Fires of Outland'"] 	= "'아웃랜드의 불꽃'" 	-- 25081
L["'March of the Legion'"] 	= "'군단의 행진'" 	-- 25082
L["'Servants of the Betrayer'"] 	= "'배신자의 하수인들'" 	-- 25083
L["'Hunt for Illidan'"] 	= "'일리단 사냥'" 	-- 27367
L["'Drums of War'"] 	= "'전쟁의 북'" 	-- 27782
L["'Blood of Gladiators'"] 	= "'검투사의 피'" 	-- 33469
L["'Fields of Honor'"] 	= "'명예의 들판'" 	-- 34847
L["'Scourgewar'"] 	= "'스컬지 전쟁'" 	-- 36467
L["'Wrathgate'"] 	= "'분노의 관문'" 	-- 40172
L["'Icecrown'"] 	= "'얼음왕관'" 	-- 40173
