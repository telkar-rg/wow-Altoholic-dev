...
do
	...
	lootTable = {
		...
		[format(L["Level %d Honor PVP"], 70)] = {	
			...
			[L["Non Set Accessories"]] = { 28378, 28377, 33920, 33921, 33922, 35317, 35319, 33923, 33056, 33064, 33057, 34576, 34577, 34578, 35326, 34579, 34580, 33853, 33918, 35320, 33919 },
		...
		[BZ["Trial of the Champion"] .. L[" (Heroic)"]] = {
			[BB["Faction Champions"]] = {	47249, 47248, 47250, 47244, 47243, 47493, 44990 },
			[BB["Argent Confessor Paletress"]] = { 47498, 47496, 47245, 47497, 47514, 47510, 47495, 47511, 47494, 
					47512, 47500, 47522, 44990 },
			[BB["Eadric the Pure"]] = { 47501, 47496, 47498, 47504, 47497, 47502, 47495, 47503, 47494, 
					47500, 47509, 47508, 44990 },
			[BB["The Black Knight"]] = { 47564, 47527, 47560, 47529, 47561, 47563, 47565, 47567, 47562,
