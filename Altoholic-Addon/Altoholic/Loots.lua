...
do
	...
	lootTable = {
		...
		[format(L["Arena Season %d"], 1)] = {	
			[BI["Druid"]] = { 28127, 28129, 28130, 28126, 28128, 28137, 28139, 28140, 28136, 28138, 31376, 31378, 31379, 31375, 31377 },
			[BI["Hunter"]] = { 28331, 28333, 28334, 28335, 28332 },
			[BI["Mage"]] = { 25855, 25854, 25856, 25857, 25858 },
			[BI["Paladin"]] = { 27704, 27706, 27702, 27703, 27705, 27881, 27883, 27879, 27880, 27882, 31616, 31619, 31613, 31614, 31618 },
			[BI["Priest"]] = { 27708, 27710, 27711, 27707, 27709, 31410, 31412, 31413, 31409, 31411 },
			[BI["Rogue"]] = {	25830, 25832, 25831, 25834, 25833 },
			[BI["Shaman"]] = { 25998, 25999, 25997, 26000, 26001,27471, 27473, 27469, 27470, 27472, 31400, 31407, 31396, 31397, 31406 },
			[BI["Warlock"]] = { 24553, 24554, 24552, 24556, 24555, 30187, 30186, 30200, 30188, 30201 },
			[BI["Warrior"]] = { 24545, 24546, 24544, 24549, 24547 },
		...
		[format(L["Arena Season %d"], 2)] = {	
			[BI["Druid"]] = { 31968, 31971, 31972, 31967, 31969, 32057, 32059, 32060, 32056, 32058, 31988, 31990, 31991, 31987, 31989 },
			[BI["Hunter"]] = { 31962, 31964, 31960, 31961, 31963 },
			[BI["Mage"]] = { 32048, 32047, 32050, 32049, 32051 },
			[BI["Paladin"]] = { 31997, 31996, 31992, 31993, 31995, 32041, 32043, 32039, 32040, 32042, 32022, 32024, 32020, 32021, 32023 },
			[BI["Priest"]] = { 32035, 32037, 32038, 32034, 32036, 32016, 32018, 32019, 32015, 32017 },
			[BI["Rogue"]] = {	31999, 32001, 32002, 31998, 32000 },
			[BI["Shaman"]] = { 32006, 32008, 32004, 32005, 32007, 32011, 32013, 32009, 32010, 32012, 32031, 32033, 32029, 32030, 32032 },
			[BI["Warlock"]] = { 31974, 31976, 31977, 31973, 31975, 31980, 31979, 31982, 31981, 31983 },
			[BI["Warrior"]] = { 30488, 30490, 30486, 30487, 30489 },
		...
		[format(L["Arena Season %d"], 3)] = {	
			[BI["Druid"]] = { 33672, 33674, 33675, 33671, 33673, 33768, 33770, 33771, 33767, 33769, 33691, 33693, 33694, 33690, 33692 },
			[BI["Hunter"]] = { 33666, 33668, 33664, 33665, 33667 },
			[BI["Mage"]] = { 33758, 33757, 33760, 33759, 33761 },
			[BI["Paladin"]] = { 33697, 33699, 33695, 33696, 33698, 33751, 33753, 33749, 33750, 33752, 33724, 33726, 33722, 33723, 33725 },
			[BI["Priest"]] = { 33745, 33747, 33748, 33744, 33746, 33718, 33720, 33721, 33717, 33719  },
			[BI["Rogue"]] = {	33701, 33703, 33704, 33700, 33702 },
			[BI["Shaman"]] = { 33708, 33710, 33706, 33707, 33709, 33713, 33715, 33711, 33712, 33714, 33740, 33742, 33738, 33739, 33741 },
			[BI["Warlock"]] = { 33677, 33679, 33680, 33676, 33678, 33683, 33682, 33685, 33684, 33686 },
			[BI["Warrior"]] = { 33730, 33732, 33728, 33729, 33731 },
		...
		[format(L["Arena Season %d"], 4)] = {
			[BI["Druid"]] = { 34999, 35001, 35002, 34998, 35000, 35112, 35114, 35115, 35111, 35113, 35023, 35025, 35026, 35022, 35024 },
			[BI["Hunter"]] = { 34992, 34994, 34990, 34991, 34993 },
			[BI["Mage"]] = { 35097, 35096, 35099, 35098, 35100 },
			[BI["Paladin"]] = { 35029, 35031, 35027, 5028, 35030, 35090, 35092, 35088, 35089, 35091, 35061, 35063, 35059, 35060, 35062 },
			[BI["Priest"]] = { 35084, 35086, 35087, 35083, 35085, 35054, 35056, 35057, 35053, 35055 },
			[BI["Rogue"]] = {	35033, 35035, 35036, 35032, 35034 },
			[BI["Shaman"]] = { 35044, 35046, 35042, 35043, 35045, 35050, 35052, 35048, 35049, 35051, 35079, 35081, 35077, 35078, 35080 },
			[BI["Warlock"]] = { 35004, 35006, 35007, 35003, 35005, 35010, 35009, 35012, 35011, 35013 },
			[BI["Warrior"]] = { 35068, 35070, 35066, 35067, 35069 },
		...
		[format(L["Arena Season %d"], 6)] = {
			[BI["Death Knight"]] = { 40827, 40868, 40787, 40809, 40848 },
			[BI["Druid"]] = { 41327, 41281, 41316, 41293, 41304, 41678, 41715, 41661, 41773, 41667, 41321, 41275, 41310, 41287, 41298 },
			[BI["Hunter"]] = { 41157, 41217, 41087, 41143, 41205 },
			[BI["Mage"]] = { 41946, 41965, 41953, 41971, 41959 },
			[BI["Paladin"]] = { 40828, 40869, 40788, 40808, 40849, 40933, 40963, 40907, 40927, 40939 },
			[BI["Priest"]] = { 41915, 41934, 41921, 41940, 41927, 41854, 41869, 41859, 41874, 41864 },
			[BI["Rogue"]] = {	41672, 41683, 41650, 41767, 41655 },
			[BI["Shaman"]] = { 41019, 41044, 40993, 41007, 41033, 41151, 41211, 41081, 41137, 41199, 41013, 41038, 40992, 41001, 41027 },
			[BI["Warlock"]] = { 41993, 42011, 41998, 42017, 42005 },
			[BI["Warrior"]] = { 40826, 40866, 40789, 40807, 40847 },
		},
		[format(L["Arena Season %d"], 7)] = {
			[BI["Death Knight"]] = { 40830, 40871, 40791, 40811, 40851 },
			[BI["Druid"]] = { 41328, 41282, 41317, 41294, 41305, 41679, 41716, 41662, 41774, 41668, 41322, 41276, 41311, 41288, 41299 },
			[BI["Hunter"]] = { 41158, 41218, 41088, 41144, 41206 },
			[BI["Mage"]] = { 41947, 41966, 41954, 41972, 41960 },
			[BI["Paladin"]] = { 40831, 40872, 40792, 40812, 40852, 40934, 40964, 40910, 40928, 40940 },
			[BI["Priest"]] = { 41916, 41935, 41922, 41941, 41928, 41855, 41870, 41860, 41875, 41865 },
			[BI["Rogue"]] = {	41673, 41684, 41651, 41768, 41656 },
			[BI["Shaman"]] = { 41020, 41045, 40995, 41008, 41034, 41152, 41212, 41082, 41138, 41200, 41014, 41039, 40994, 41002, 41028 },
			[BI["Warlock"]] = { 41994, 42012, 41999, 42018, 42006 },
			[BI["Warrior"]] = { 40829, 40870, 40790, 40810, 40850 },
		},
		...
		[L["Emblem of Triumph"]] = {
			...
			["x50"] = { 40807, 40808, 40809, 40866, 40868, 40869, 40927, 40963, 41001, 41007, 41038, 41044, 41137, 41143, 41211, 41217, 41275, 41281, 41287, 41293, 41683, 41715, 41767, 41773, 41869, 41874, 41934, 41940, 41965, 41971, 42011, 42017, 47734, 47735, 48722, 48724,  },
		...
		["T9.75-Set"] = {
			[format("%s (%s 25 %s)", L["Regalia of the Grand Conqueror"], BZ["Trial of the Crusader"], PLAYER_DIFFICULTY2)] = { 	-- Paladin, Priest, Warlock
			...
			[format("%s (%s 25 %s)", L["Regalia of the Grand Protector"], BZ["Trial of the Crusader"], PLAYER_DIFFICULTY2)] = { 	-- Warrior, Hunter, Shaman
			...
			[format("%s (%s 25 %s)", L["Regalia of the Grand Vanquisher"], BZ["Trial of the Crusader"], PLAYER_DIFFICULTY2)] = { 	-- Rogue, Death Knight, Mage, Druid
